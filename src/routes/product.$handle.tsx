  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          {product.productType && (
            <p className="text-xs uppercase tracking-widest text-ember mb-3">{product.productType}</p>
          )}
          <h1 className="text-display text-5xl md:text-6xl uppercase leading-none">{product.title}</h1>
          <p className="mt-6 text-3xl text-gold font-semibold">
              ...
              <div className="flex flex-wrap gap-2">
                {variants.map((v) => (
                  <button
                    ...
                    className={`px-4 py-2 text-xs uppercase tracking-widest rounded-sm border transition ${
                      v.id === variantId
          ...
          <Button
            ...
            size="lg"
            className="mt-10 w-full gradient-ember text-ember-foreground hover:opacity-90 font-display tracking-widest uppercase text-base"
          >
            {isLoading ? (
